...
function displayCountries(countries) {
    playBtn.addEventListener("click", () => {
        ...
        createCountryButton(countries, sortNumber);
    });
}

function createCountryButton(countries, sortNumber) {
    for (let i = 0; i < 4; i++) {
    ...
    createCountryFlag(countries, sortNumber);
}

function createCountryFlag(countries, sortNumber) {
    for (let i = 0; i < 1; i++) {
    ...
    modifyCountryButton(countries, numberFlag);
}

function modifyCountryButton(countries, numberFlag) {
